...
public class Integer
{
    ...
    {
        SoftOmni.ParsingResults.ParsingResult parsingResult =
            SoftOmni.ParsingResults.ParsingResult.CreateFailure(TestNegativeOne,
                ErrorMessage);
    ...
    {
        SoftOmni.ParsingResults.ParsingResult parsingResult =
            SoftOmni.ParsingResults.ParsingResult.CreateFailure(ValidValue,
                ErrorMessage);
    ...
    {
        SoftOmni.ParsingResults.ParsingResult parsingResult =
            SoftOmni.ParsingResults.ParsingResult.CreateFailure(ValidValue, EmptyString);
    ...
    {
        SoftOmni.ParsingResults.ParsingResult parsingResult =
            SoftOmni.ParsingResults.ParsingResult.CreateCustom(TestNegativeOne,
                ErrorMessage);
    ...
    {
        SoftOmni.ParsingResults.ParsingResult parsingResult =
            SoftOmni.ParsingResults.ParsingResult.CreateCustom(ValidValue,
                ErrorMessage);
    ...
    {
        SoftOmni.ParsingResults.ParsingResult parsingResult =
            SoftOmni.ParsingResults.ParsingResult.CreateCustom(ValidValue, EmptyString);
