namespace SoftOmni.Parsing.Commons.ParsingResults.Tests.ParsingResult.EqualityOperators;
...
public class Integer
{
    ...
    {
        SoftOmni.Parsing.Commons.ParsingResults.ParsingResult parsingResult =
            SoftOmni.Parsing.Commons.ParsingResults.ParsingResult.CreateFailure(TestNegativeOne,
                ErrorMessage);
    ...
    {
        SoftOmni.Parsing.Commons.ParsingResults.ParsingResult parsingResult =
            SoftOmni.Parsing.Commons.ParsingResults.ParsingResult.CreateFailure(ValidValue,
                ErrorMessage);
    ...
    {
        SoftOmni.Parsing.Commons.ParsingResults.ParsingResult parsingResult =
            SoftOmni.Parsing.Commons.ParsingResults.ParsingResult.CreateFailure(ValidValue, EmptyString);
    ...
    {
        SoftOmni.Parsing.Commons.ParsingResults.ParsingResult parsingResult =
            SoftOmni.Parsing.Commons.ParsingResults.ParsingResult.CreateCustom(TestNegativeOne,
                ErrorMessage);
    ...
    {
        SoftOmni.Parsing.Commons.ParsingResults.ParsingResult parsingResult =
            SoftOmni.Parsing.Commons.ParsingResults.ParsingResult.CreateCustom(ValidValue,
                ErrorMessage);
    ...
    {
        SoftOmni.Parsing.Commons.ParsingResults.ParsingResult parsingResult =
            SoftOmni.Parsing.Commons.ParsingResults.ParsingResult.CreateCustom(ValidValue, EmptyString);
