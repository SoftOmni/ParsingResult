...
public class ToParsingResult
{
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, ErrorMessage);

ParsingResults.ParsingResult parsingResult = progressiveParsingResult.ToParsingResult();
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, EmptyString);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, EmptyString, FailedIndex);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, EmptyString, NegativeIndex);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, ErrorMessage, PositiveValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, EmptyString, PositiveValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, ErrorMessage, NegativeValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, ErrorMessage, TestZero);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, EmptyString, TestZero);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, ErrorMessage, TestOne);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, EmptyString, TestOne);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, ErrorMessage, TestNegativeOne);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, ErrorMessage, TestBigPositive);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, EmptyString, TestBigPositive);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, ErrorMessage, TestBigNegative);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, EmptyString, TestBigNegative);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, ErrorMessage, ValidValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(TestNegativeOne, EmptyString, ValidValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}*/
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, FailedIndex);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, FailedIndex);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, NegativeIndex);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, NegativeIndex);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, PositiveValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, PositiveValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, NegativeValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, NegativeValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, TestZero);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, TestZero);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, TestOne);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, TestOne);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, TestNegativeOne);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, TestNegativeOne);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, TestBigPositive);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, TestBigPositive);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, TestBigNegative);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, TestBigNegative);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, ErrorMessage, ValidValue);
...
Assert.Equal(, progressiveParsingResult.NewIndex );}
    ...
    {ParsingResults.ProgressiveParsingResult progressiveParsingResult =
            ParsingResults.ProgressiveParsingResult.CreateFailure(ValidValue, EmptyString, ValidValue);
