...
public class ToString
{
    ...
    public void Failure_WithBigPositive()
    {
        ...
        Assert.Equal($"Failed parsing result at index {TestBigPositive} in \"{ErrorMessage}\"", parsingResult.ToString());
    }
    ...
    public void Failure_WithBigNegative()
    {
        ...
        Assert.Equal($"Failed parsing result at index {TestBigNegative} in \"{ErrorMessage}\"", parsingResult.ToString());
    }
    ...
    public void Custom_WithNegativeOne()
    {
        ...
        Assert.Equal($"Custom parsing result at index {TestNegativeOne} in \"{ErrorMessage}\"", parsingResult.ToString());
    }
    ...
    public void Custom_WithBigPositive()
    {
        ...
        Assert.Equal($"Custom parsing result at index {TestBigPositive} in \"{ErrorMessage}\"", parsingResult.ToString());
    }
    ...
    public void Custom_WithBigNegative()
    {
        ...
        Assert.Equal($"Custom parsing result at index {TestBigNegative} in \"{ErrorMessage}\"", parsingResult.ToString());
    }
